...
<html lang="en">
  <head>
    ...
    <title>@yield('titulo', 'Náutica') | Sistema de Gestión</title>
  ...
  <body class="nav-md">
    ...
    <script src="{{ asset('template/js/moment/moment.min.js')}}"></script>
    <script src="{{ asset('template/js/datepicker/daterangepicker.js')}}"></script>
